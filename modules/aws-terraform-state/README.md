...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_backup"></a> [backup](#module\_backup) | ../aws-resource-backup | n/a |

## Resources

| Name | Type |
|------|------|
| [aws_kms_key.kms_key_encryption](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kms_key) | resource |
...
| [aws_s3_bucket_public_access_block.s3_bucket_access](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_public_access_block) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_bucket_name"></a> [bucket\_name](#input\_bucket\_name) | Name for the bucket S3 | `string` | n/a | yes |
| <a name="input_use_default_kms_key_for_encryption"></a> [use\_default\_kms\_key\_for\_encryption](#input\_use\_default\_kms\_key\_for\_encryption) | This variable creates a KMS key for default | `bool` | n/a | yes |
